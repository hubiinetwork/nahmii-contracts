...
module.exports = function (glob) {
    describe('ClientFund', function () {
        ...
        before(async () => {
            ...
            web3MockedClientFundAuthorizedService = await MockedClientFundService.new(glob.owner, glob.web3AccesorManager.address);
            ...
            web3MockedClientFundUnauthorizedService = await MockedClientFundService.new(glob.owner, glob.web3AccesorManager.address);
