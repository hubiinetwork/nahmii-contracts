    ...
    describe('Validator', () => {
        ...
        describe('isGenuineWalletSignature()', () => {
            ...
            describe('if not genuine', () => {
                it('should return false', async () => {
                    (await ethersValidator.isGenuineWalletSignature(hash, signature, glob.user_a))
                        .should.be.false;
                });
            });
            ...
            describe('if genuine', () => {
                it('should return true', async () => {
                    (await ethersValidator.isGenuineWalletSignature(hash, signature, glob.owner))
                        .should.be.true;
                });
            });
        });
        ...
        describe('isGenuineOperatorSignature()', () => {
            ...
            describe('if not genuine', () => {
                ...
                it('should return false', async () => {
                    (await ethersValidator.isGenuineOperatorSignature(hash, signature))
                        .should.be.false;
                });
            });
        ...
        describe('isGenuinePaymentWalletHash()', () => {
            ...
            describe('if not genuine', () => {
                ...
                it('should return false', async () => {
                    (await ethersValidator.isGenuinePaymentWalletHash(payment))
                        .should.be.false;
                });
            });
        ...
        describe('isGenuinePaymentOperatorHash()', () => {
            ...
            describe('if not genuine', () => {
                ...
                it('should return false', async () => {
                    (await ethersValidator.isGenuinePaymentOperatorHash(payment))
                        .should.be.false;
                });
            });
        ...
        describe('isGenuinePaymentWalletSeal()', () => {
            ...
            describe('if not genuine hash', () => {
                ...
                it('should return false', async () => {
                    (await ethersValidator.isGenuinePaymentWalletSeal(payment))
                        .should.be.false;
                });
            });
        ...
        describe('isGenuinePaymentOperatorSeal()', () => {
            ...
            describe('if not genuine hash', () => {
                ...
                it('should return false', async () => {
                    (await ethersValidator.isGenuinePaymentOperatorSeal(payment))
                        .should.be.false;
                });
            });
