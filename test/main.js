...
// const ERC20Token = artifacts.require('TestER20');
...
contract('Smart contract checks', function () {
    ...
    //     try {
    //         await glob.web3Erc20.mint(glob.owner, 100);
    //         await glob.web3Erc20.mint(glob.user_a, initialTokensForAll);
    //         await glob.web3Erc20.mint(glob.user_b, initialTokensForAll);
    //         await glob.web3Erc20.mint(glob.user_c, initialTokensForAll);
    //         await glob.web3Erc20.mint(glob.user_d, initialTokensForAll);
    //         await glob.web3Erc20.mint(glob.user_e, initialTokensForAll);
    //     } catch (err) {
