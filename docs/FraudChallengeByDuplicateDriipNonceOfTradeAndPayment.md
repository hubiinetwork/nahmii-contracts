...
**Execution cost**: less than 42593 gas

**Deployment cost**: less than 1427000 gas

**Combined cost**: less than 1469593 gas
...
## Events
### ChallengeByDuplicateDriipNonceOfTradeAndPaymentEvent(tuple,tuple,address)
